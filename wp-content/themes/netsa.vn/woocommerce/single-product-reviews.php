...
<div id="reviews" class="woocommerce-Reviews">
	<div id="comments">
		<h2 class="woocommerce-Reviews-title title-line"><?php
		...
		<div id="review_form_wrapper">
			<div id="review_form">
				<?php
					...
					$comment_form['comment_field'] .= '<p class="comment-form-comment"><textarea placeholder="' . esc_html__( 'Your review', 'woocommerce' ) . '" id="comment" name="comment" cols="45" rows="8" aria-required="true" required></textarea></p>';
