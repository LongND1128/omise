 ...
 */
/*
 * Class Name: WP_Bootstrap_sidenav
...
if ( ! class_exists( 'WP_Bootstrap_sidenav' ) ) {
	/**
	 * WP_Bootstrap_sidenav class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class WP_Bootstrap_sidenav extends Walker_Nav_Menu {
		/**
		 * Start Level.
		 *
		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
			...
			$output .= "\n$indent<ul role=\"menu\" class=\" nav nav-show\" >\n";
		}
		/**
		 * Start El.
		 *
				...
				if ( ! empty( $item->attr_title ) ) :
					...
					if ( false !== $pos ) :
						$item_output .= '<a' . $attributes . '><span class="glyphicon ' . esc_attr( $item->attr_title ) . '" aria-hidden="true"></span>&nbsp;';
									...
									$item_output .= '<a' . $attributes . '><i class="fa fa-' . esc_attr( $item->attr_title ) . '" aria-hidden="true"></i>&nbsp;';
											endif;
				else :
